...
// adw.SplitButton, when they need to habe both an icon and a label, as follows:
//
...
//
//
// AdwSplitButton's CSS node is called buttoncontent. It contains the subnodes
// image and label.
//
...
func NewButtonContent() *ButtonContent {
	...
	_buttonContent = wrapButtonContent(externglib.Take(unsafe.Pointer(_cret)))
